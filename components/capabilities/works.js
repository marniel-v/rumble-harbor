...
export const works = [
  {
    ...
    lead: "I’m a senior software engineer who enjoys solving long-standing, complex problems with simple solutions. I’ve always seen software development as a kind of puzzle: understanding how a system really works, finding where the complexity comes from, and figuring out how to make it better. I love learning, and I’m particularly drawn to problems where there is something to untangle, optimise, or simplify.",
    body: [
      "I work across the full stack, with particular strength in backend architecture, data-intensive applications, distributed systems, cloud infrastructure, and algorithmic problem solving. I’ve built and evolved production systems across B2B analytics, multi-cloud infrastructure, manufacturing, and logistics, often working within real-world constraints rather than clean greenfield environments. That suits me. I’m an engineer at heart, and I’m comfortable digging into difficult problems and staying with them until they’re solved.",
      "I care about building software that is reliable, secure, maintainable, and simple enough to evolve over time. I’m pragmatic about how I get there: understand the problem, focus on what matters, and choose the right solution for the constraints rather than adding complexity for its own sake. I’m persistent by nature, and I don’t give up easily when a problem is worth solving.",
      "Outside of software, I’m usually somewhere between music, gaming, and travelling—apparently I have a habit of turning perfectly good hobbies into problems I can spend hours trying to solve. I suppose some things don’t change.",
    ],
    bio: true,
    views: [],
    ready: true,
  ...
  },
  {
    ...
    views: [
      ...
      },
      {
        ...
        note: "Outside of software, I’m into music, gaming (both board and video), and travelling. Basically, if it involves a good challenge, a bit of competition, or an excuse to go somewhere new, I’m probably interested.",
      },
    ],
    ready: true,
  },
