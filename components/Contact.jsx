...
export default function Contact() {
  ...
  const validate = () => {
    if (!form.name.trim()) return "Add your name so I know who I'm talking to.";
      ...
      <div className="container contact__inner">
        <div className="contact__intro">
          ...
          <p className="contact__lead">
            Tell us what you have in mind and I&apos;ll get back to you soon.
          </p>
        ...
        <form className="contact__form" onSubmit={onSubmit} noValidate>
          ...
          {status === "sent" && (
            <p className="form-note form-note--ok" role="status">
              Thanks, your message is in. I&apos;ll be in touch shortly.
            </p>
          )}
